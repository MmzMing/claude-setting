...
```bash
DRAWIO_CMD=`/mnt/c/Program Files/draw.io/draw.io`
```
...
`/mnt/c/Program Files/draw.io/draw.io`

# Per-user install (if the above does not exist)
`/mnt/c/Users/$WIN_USER/AppData/Local/Programs/draw.io/draw.io`
```
...
```bash
`/mnt/c/Program Files/draw.io/draw.io` -x -f png -e -b 10 -o diagram.drawio.png diagram.drawio
```
